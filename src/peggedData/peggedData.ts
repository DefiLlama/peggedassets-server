...
export default [
  ...
  */
  ...
  },
  {
    id: "391",
    name: "GOLDST",
    address: "strato:0xcdc93d30182125e05eec985b631c7c61b3f63ff0",
    symbol: "GOLDST",
    url: "https://strato.nexus/",
    description:
      "GOLDST is a commodity-backed token on the STRATO chain (BlockApps Mercata) where 1 GOLDST represents 1 troy ounce of physical gold. Used as collateral and underlying across STRATO's DeFi suite. STRATO is the chain/platform; there is no separate STRATO token.",
    mintRedeemDescription:
      "GOLDST is minted and redeemed by BlockApps against physical gold custody. The USD price is published on-chain by the STRATO PriceOracle precompile, tracking 1 troy ounce of gold.",
    onCoinGecko: "false",
    gecko_id: "goldst",
    cmcId: null,
    pegType: "peggedVAR",
  ...
  },
  {
    id: "392",
    name: "SILVST",
    address: "strato:0x2c59ef92d08efde71fe1a1cb5b45f4f6d48fcc94",
    symbol: "SILVST",
    url: "https://strato.nexus/",
    description:
      "SILVST is a commodity-backed token on the STRATO chain (BlockApps Mercata) where 1 SILVST represents 1 troy ounce of physical silver. Used as collateral and underlying across STRATO's DeFi suite. STRATO is the chain/platform; there is no separate STRATO token.",
    mintRedeemDescription:
      "SILVST is minted and redeemed by BlockApps against physical silver custody. The USD price is published on-chain by the STRATO PriceOracle precompile, tracking 1 troy ounce of silver.",
    onCoinGecko: "false",
    gecko_id: "silvst",
    cmcId: null,
    pegType: "peggedVAR",
