...
},
{
  ...
  description:"hyUSD is a secure high yield savings flatcoin with up to 6% rewards outpacing inflation in over 100 countries around the world.",
  mintRedeemDescription:"Minting requires a deposit of the defined collateral tokens in equal value amounts to the RToken smart contracts.",
  onCoinGecko: "true",
...
},
{
  ...
  description:"CADC tokens are fully backed 1:1 with Canadian Dollars held in a bank account in Canada.",
  mintRedeemDescription:"CADC is issued by PAYTRIE AB Inc., a FINTRAC regulated Money Services Business (M19690633), and backed by fully reserved assets, and redeemable on a 1:1 basis for Canadian dollars",
  onCoinGecko: "true",
  gecko_id: "cad-coin",
  cmcId: "8690",
  pegType: "peggedCAD",
...
},
{
  ...
  description:"Ethereum enabled crypto-native synthetic dollar which provides an embedded yield to users and achieves price stability through delta-neutral hedging across centralized and decentralized venues",
  mintRedeemDescription:"Ethena enables users to deposit either USD,  Ethereum or liquid staking tokens as collateral to create USDe. Stability is ensured through delta-neutral hedging process across centralized and decentralized exchanges.",
  onCoinGecko: "true",
